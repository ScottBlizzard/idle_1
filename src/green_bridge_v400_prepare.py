...
TEST_FILES = (
    ...
    "tests/test_green_bridge_v400_branch_semantics.py",
    "tests/test_green_bridge_v400_resource_plan.py",
    "tests/test_green_bridge_v400_tensor_program.py",
    "tests/test_green_bridge_v400_gpt2_program.py",
)
