...
| [Grant et al., *Addressing Divergent Representations from Causal Interventions*](https://proceedings.iclr.cc/paper_files/paper/2026/hash/133e588e1429f9f1e25b215da145580e-Abstract-Conference.html) | ICLR 2026 Oral; establishes divergent interventions and motivates the project's original target | **Deliberate foundation and adversarial reference, not a scoop** | GREEN must isolate the unresolved silent-failure regime: an intervention can look behaviorally successful while supporting the wrong mechanism; certification must prospectively predict an independent consequence beyond Grant's diagnosis |
